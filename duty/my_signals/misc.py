...
def a(event: MySignalEvent) -> str:
    event.edit(f'''
📖 Помощь по использованию дежурного BOTS
📃 Список сигналов : https://vk.com/@personal_bot_lp-signals
⚙ Управление этим дежурным : {event.db.host}

📗 [https://vk.com/personal_bot_lp|BOTS]
📘 [https://vk.com/iris_cm|Ирис]

🙎‍♂️Администраторы :
⚙️James Gladkih - https://vk.com/james_gladkih
⚙️Сергей Соловьев - https://vk.com/id721779603
📌Писать если агент не отвечает

👨‍💻 Агенты ТП BOTS :
⚜️Adam Frymov - https://vk.com/adam_frymov
📌Писать по вопросам бота 

🔗 Также за помощью вы можете обратиться в чат техподдержки
