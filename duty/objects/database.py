...
class _StandardDefaults(__UserDefinedDefaults):
    ...
    responses = _Responses({
        ...
        "user_ret_err_no_access": "❗ Не удалось добавить {ссылка}.<br> Возможно, он не в моих друзьях или он уже в беседе",
        "user_ret_err_vk": "❗ Не удалось добавить пользователя {ссылка}.<br>Ошибка ВК.<br>",
        "user_ret_err_unknown": "❗ Не удалось добавить пользователя {ссылка}.<br>Неизвестная ошибка",
        ...
        "not_in_trusted": "Ты ещо кто ? Я тебе не доверяю 😑",
        ...
        "trusted_success_add": "✅ {ссылка} в доверенных",
        "trusted_success_rem": "✅ {ссылка} удален из доверенных",
        "trusted_list": "Пользователи которым я доверяю:"
    })
